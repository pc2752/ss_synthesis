...
def GAN_generator(singer_label, phones, f0_notation, rand):
    ...
    deconv1 = tf.image.resize_images(conv8, size=(8,1), method=tf.image.ResizeMethod.BILINEAR)
    ...
    deconv2 = tf.image.resize_images(deconv1, size=(16,1), method=tf.image.ResizeMethod.BILINEAR)
    ...
    deconv3 = tf.image.resize_images(deconv2, size=(32,1), method=tf.image.ResizeMethod.BILINEAR)
    ...
    deconv4 = tf.image.resize_images(deconv3, size=(64,1), method=tf.image.ResizeMethod.BILINEAR)
    ...
    deconv5 = tf.image.resize_images(deconv4, size=(128,1), method=tf.image.ResizeMethod.BILINEAR)
