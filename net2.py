        ...
        for epoch in xrange(start_epoch, config.num_epochs):
            ...
            with tf.variable_scope('Training'):
                ...
                for inputs, feats_targets, targets_f0_1, targets_f0_2, pho_targs, singer_ids, Flag in data_generator:
                    ...
                    if teacher_train:
                        ...
                        f0_outputs_1 = sess.run(f0_probs_midi, feed_dict = {input_placeholder: input_noisy,singer_embedding_placeholder: singer_ids.reshape(-1,1)} )
                        if Flag:
            ...
            with tf.variable_scope('Validation'):
                ...
                for inputs, feats_targets, targets_f0_1, targets_f0_2, pho_targs, singer_ids, Flag in val_generator:
                    ...
                    step_loss_total = sess.run(reconstruct_loss, feed_dict={f0_input_placeholder_midi: f0_2_one_hot, pho_input_placeholder: pho_one_hot, output_placeholder: feats_targets,singer_embedding_placeholder: singer_ids.reshape(-1,1)})
...
def synth_file(file_path=config.wav_dir, show_plots=True, save_file=True):
    ...
    with tf.Graph().as_default():
        ...
        utils.feats_to_audio(haha[:5000,:],'Test_VKOW_sing_20_from_VKOW.wav')
