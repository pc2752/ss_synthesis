...
def synth_file(file_path=config.wav_dir, show_plots=True, save_file=True):
    ...
    file_name = 'timit_DR3_MSFV0_+SI1262.hdf5'



    speaker_file = 'timit_DR3_MSFV0_+SI1262.hdf5'
    ...
    with tf.Graph().as_default():
        ...
        utils.feats_to_audio(haha[:5000,:],'Test_set_speaker_MSFV0.wav')

        utils.feats_to_audio(speaker_feats[:5000,:],'Test_set_speaker_MSFV0_ori.wav')
